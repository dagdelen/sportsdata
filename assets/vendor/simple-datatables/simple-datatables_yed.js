                ...
                (function() {
                            ...
                            return t.prototype.init = function() {
                                ...
                                for (var a, o, r, l, d, c = function(t, e, s) {
                                    ...
                                    if (!n || !0 !== u[v] && !0 !== p[v]) {
                                        if (!0 === u[w])
                                        ...
                                        else !0 === p[v] ? b.push((new h).setValue(this.options._const.action, this.options._const.replaceElement).setValue(this.options._const.oldValue, x(l)).setValue(this.options._const.newValue, x(m[v])).setValue(this.options._const.route, i.concat(w))) : (b.push((new h).setValue(this.options._const.action, this.options._const.removeElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, x(l))), u.splice(w, 1), f.splice(w, 1), g = Math.min(u.length, p.length), w -= 1, v -= 1);
                                            ...
                                            nodeName: "#text",
                                            data: l.data
                                        }), g = Math.min(u.length, p.length)) : (b.push((new h).setValue(this.options._const.action, this.options._const.addElement).setValue(this.options._const.route, i.concat(w)).setValue(this.options._const.element, x(l))), u.splice(w, 0, !0), f.splice(w, 0, x(l)), g = Math.min(u.length, p.length));
                                        else if (u[w] !== p[v]) {
                    ...
                    const tt = {
                            ...
                            labels: {
                                ...
                                noRows: "Hiçbir girdi bulunamadı",
                                noResults: "Arama sorgunuzla eşleşen sonuç yok",
                                info: "{start}/{end} görünüyor,  toplam {rows} kayıt"
                            },
